...
function FormProduto({ produtoParaEditar = null, onClose, onSalvar }) {
  const Editing = Boolean(produtoParaEditar);
  const [formData, setFormData] = useState({
   nome: produtoParaEditar?.nome || "",
    ...
    minEstoque: produtoParaEditar?.minEstoque || "",
  ...
  function handleSubmit(e) {
    ...
    const NovoProduto = {
      id: Editing ? produtoParaEditar.id : crypto.randomUUID(),
      nome: formData.nome,
      ...
      <div className={style.form_centro}>
        <form className={style.formularioContainer} onSubmit={handleSubmit}>
          <div className={style.formularioCabecalho}>
            <h2 className={style.formularioTitulo}>{Editing ? "Editar Produto" : "Novo Produto"}</h2>
          ...
          <div className={style.linhaDupla}>
            <div className={style.campoGrupo}>
              <label htmlFor="estoque" className={style.rotulo}>
                Estoque Atual
              </label>
              <input
                type="number"
            ...
            <div className={style.campoGrupo}>
              <label htmlFor="minEstoque" className={style.rotulo}>
                Mínimo Obrigatório
              </label>
              <input
                type="number"
          ...
          <div className={style.linhaDupla}>
            <div className={style.campoGrupo}>
              ...
              >
                ...
                <option value="calcados-casual">
                  Calçados Casuais / Tênis
                </option>
                <option value="calcados-formal">
                  Calçados Formais / Sapatos
                </option>
          ...
          <div className={style.formularioAcoes}>
            ...
            <button type="submit" className={style.botaoSalvar}>
              {Editing ? "Salvar alteração" : "Criar produto"}
            </button>
          </div>
        </form>
      </div>
